  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#18180f] flex flex-col items-center justify-center p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 w-full max-w-7xl">
          ...
          <Link href="/withdrawal" className="group bg-[#23232a] border border-gray-700 rounded-lg flex flex-col items-center p-8 transition hover:bg-[#27272f] hover:scale-105 cursor-pointer">
            <span className="text-5xl mb-4">💸</span>
            <span className="text-lg font-semibold text-white tracking-wide">WITHDRAWAL</span>
          </Link>
        </div>
      </div>
    </>
